...
// ─────────────────────────────────────────────
function PrivacyPolicyContent({ s, effectiveDate }: { s: any; effectiveDate: string }) {
  return (
    <>
      ...
      <Text style={s.docBody}>
        ...
        Device type, operating system, app version, and anonymised usage analytics
      ...
      <Text style={s.docBody}>
        ...
        delete your account, all personal data including health records, symptom logs,
        and profile information will be permanently deleted within 30 days, except where
...
// ─────────────────────────────────────────────
function TermsOfServiceContent({ s, effectiveDate }: { s: any; effectiveDate: string }) {
  return (
    <>
      ...
      <Text style={s.docBody}>
        ...
        or that violates the rights of others. We reserve the right to remove
        content and terminate accounts that violate these standards.
      </Text>
