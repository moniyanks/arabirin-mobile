...
export function buildCycleHero({
  ...
  return {
    ...
    meta: nextPeriodDate ? `Next period: ${nextPeriodDisplay}` : undefined,
...
export function buildTtcHero(fertilityInsight: any): HomeViewModel['hero'] {
...
export function buildPregnancyHero(pregnancyInsight: any): HomeViewModel['hero'] {
  return {
    kind: 'pregnancy',
    ...
    meta:
      pregnancyInsight?.weeksRemainingLabel || 'Track how your body feels as this season unfolds.'
  }
}
