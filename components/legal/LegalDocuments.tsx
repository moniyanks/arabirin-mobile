  ...
  return (
    <>
      ...
      <Text style={s.docBody}>
        This Privacy Policy describes how Àràbìrín Technologies ("we", "us", or "our")
        collects, uses, stores, and protects your personal information when you use the
        Àràbìrín mobile application ("the App"). By using the App, you agree to the
        practices described in this Policy.
      </Text>
      <Text style={s.docBody}>
        We are committed to protecting your privacy and handling your data with the
        highest standards of care, particularly given the sensitive nature of reproductive
        health information. This Policy is designed to comply with the General Data
        Protection Regulation (GDPR), the UK GDPR, the Personal Information Protection
        and Electronic Documents Act (PIPEDA), the California Consumer Privacy Act (CCPA),
      ...
      <Text style={s.docBody}>
        ...
        For all data protection enquiries, data subject access requests, or complaints,
      ...
      <Text style={s.docBody}>
        ...
        Your chosen display name, date of birth (for age verification), height, weight,
        and health journey preference.
      </Text>
      <Text style={s.docBody}>
        <Text style={s.docHighlight}>Special Category Health Data: </Text>
        Menstrual cycle dates, period start and end dates, symptom logs including mood,
        flow intensity, pain levels, energy levels, and free-text health notes. This
        constitutes "special category data" under GDPR and is afforded the highest level
        of protection under applicable law.
      </Text>
      <Text style={s.docBody}>
        <Text style={s.docHighlight}>Technical Information: </Text>
        Device type, operating system, app version, and limited technical information
        used to maintain security, diagnose issues, and improve app performance.
      </Text>
      <Text style={s.docBody}>
        <Text style={s.docHighlight}>Consent Records: </Text>
        A timestamped record of when you viewed and agreed to this Privacy Policy and
        our Terms of Service, the platform you used, and the app version in use at the
        time of consent. This record is maintained for legal compliance purposes.
      </Text>
      ...
      <Text style={s.docBullet}>
        ...
        For the processing of your special category reproductive health data. You may
      ...
      <Text style={s.docBullet}>• Provide personalised menstrual cycle tracking and predictions</Text>
      ...
      <Text style={s.docBody}>
        We will never sell, rent, or trade your personal data to third parties for
        marketing purposes. We will never use your reproductive health data for
        advertising targeting.
      </Text>

      <Text style={s.docSection}>5. Data Storage and Security</Text>
      <Text style={s.docBody}>
        Your data is stored on Supabase infrastructure, which uses PostgreSQL databases
        with row-level security policies ensuring your data is accessible only to you.
      ...
      <Text style={s.docBody}>
        We may use trusted third-party service providers to support authentication,
        hosting, storage, security, and app operations. These providers process data
        only on our instructions and under appropriate contractual safeguards.
      </Text>

      <Text style={s.docSection}>6. Data Retention</Text>
      <Text style={s.docBody}>
        We retain your personal data for as long as your account is active. You may
        request deletion of your account and associated personal data at any time by
        contacting us at the email address provided in this Policy. Where an in-app
        account deletion feature is available, you may also initiate deletion directly
        within the App.
      </Text>
      <Text style={s.docBody}>
        Upon receiving a valid deletion request, all personal data including health
        records, symptom logs, and profile information will be permanently deleted
      ...
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right of Access: </Text>Request a copy of all personal data we hold about you</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Rectification: </Text>Correct inaccurate or incomplete data</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Erasure: </Text>Request deletion of your personal data ("right to be forgotten")</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Restriction: </Text>Request that we restrict processing of your data</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Data Portability: </Text>Receive your data in a machine-readable format</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Object: </Text>Object to processing based on legitimate interests</Text>
      <Text style={s.docBullet}>• <Text style={s.docHighlight}>Right to Withdraw Consent: </Text>Withdraw consent for processing special category data at any time</Text>
      ...
      <Text style={s.docBody}>
        ...
        by law. The effective date at the top of this document indicates when it was
        last revised.
      </Text>
  ...
  return (
    <>
      ...
      <Text style={s.docBody}>
        ...
        you ("User", "you") and Àràbìrín Technologies ("we", "us", "our") governing
        your access to and use of the Àràbìrín mobile application ("the App").
      </Text>
      <Text style={s.docBody}>
      ...
      <Text style={s.docBody}>
        Àràbìrín is a personal health tracking application designed to help users
        monitor their menstrual cycles, log symptoms, and access educational health
        information. The App is intended for general wellness and informational
        purposes only.
      </Text>
      <Text style={s.docBody}>
        ...
        {' '}Nothing in the App constitutes or should be construed as medical advice.
        The information and insights provided are for informational and educational
      ...
      <Text style={s.docBody}>
        ...
        have read in the App.
      </Text>
      <Text style={s.docBody}>
        The App is not intended for emergency use. If you believe you are experiencing
        a medical emergency, call your local emergency services or seek immediate
        medical attention.
      </Text>

      <Text style={s.docSection}>3. Account Registration</Text>
      <Text style={s.docBody}>
        To use the App, you must register an account using a valid email address.
      ...
      <Text style={s.docBody}>
        You may only create one account per email address. You must provide accurate
      ...
      <Text style={s.docBullet}>• Use the App for any unlawful purpose or in violation of any applicable laws</Text>
      <Text style={s.docBullet}>• Attempt to gain unauthorised access to any part of the App or its infrastructure</Text>
      <Text style={s.docBullet}>• Reverse engineer, decompile, or disassemble any part of the App</Text>
      ...
      <Text style={s.docBullet}>• Impersonate any person or entity or misrepresent your affiliation</Text>
      <Text style={s.docBullet}>• Collect or harvest personal data from other users</Text>
      <Text style={s.docBullet}>• Use the App in any manner that could damage, overburden, or impair our services</Text>
      ...
      <Text style={s.docBody}>
        ...
        property of Àràbìrín Technologies and are protected by copyright, trademark,
      ...
      <Text style={s.docBody}>
        ...
        these Terms. This licence does not include any resale or commercial use of
        the App or its contents.
      </Text>

      <Text style={s.docSection}>6. Health Data and Accuracy</Text>
      <Text style={s.docBody}>
        Cycle predictions, fertile window estimates, and health insights provided by
        the App are based on data you input and general statistical models. These
        predictions are not medically validated and may not be accurate for every
        individual.
      </Text>
      <Text style={s.docBody}>
        You acknowledge that cycle tracking is not a reliable method of contraception.
        The App should not be used as a family planning or contraceptive tool. We
        expressly disclaim any liability for pregnancy, health outcomes, or any other
        consequences arising from reliance on the App's predictions or insights.
      </Text>

      <Text style={s.docSection}>7. Sisters Circle Community</Text>
      <Text style={s.docBody}>
        The Sisters Circle community feature (when available) allows users to share
        experiences and information. Content shared in this feature is the sole
        responsibility of the user who posted it. We do not endorse or verify the
        accuracy of community posts.
      </Text>
      <Text style={s.docBody}>
        You agree not to post content that is harmful, abusive, discriminatory,
        or that violates the rights of others. We may review, remove, restrict,
        or moderate community content at our discretion to protect users and
      ...
      <Text style={s.docBody}>
        ...
        completeness, or usefulness of any information provided through the App.
      </Text>

      <Text style={s.docSection}>9. Limitation of Liability</Text>
      <Text style={s.docBody}>
        TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, ÀRÀBÌRÍN TECHNOLOGIES
        SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL,
        OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF DATA, LOSS OF
        PROFITS, OR PERSONAL INJURY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE
        OF THE APP.
      </Text>
      <Text style={s.docBody}>
        Our total liability to you for any claim arising out of these Terms or the
        App shall not exceed the amount paid by you (if any) to access the App in
        the twelve months preceding the claim.
      </Text>

      <Text style={s.docSection}>10. Indemnification</Text>
      <Text style={s.docBody}>
        You agree to indemnify, defend, and hold harmless Àràbìrín Technologies and
        ...
        connected with your use of the App or violation of these Terms.
      </Text>

      <Text style={s.docSection}>11. Termination</Text>
      <Text style={s.docBody}>
        We reserve the right to suspend or terminate your account and access to the
        App at our sole discretion, with or without notice, for conduct that we believe
      ...
      <Text style={s.docBody}>
        ...
        conflict of law principles. For users in the EU or UK, the mandatory
      ...
      <Text style={s.docBody}>
        ...
        of material changes through the App. Your continued use of the App after
        such changes constitutes your acceptance of the revised Terms. Where required
        by law, we will seek your renewed consent.
      </Text>
